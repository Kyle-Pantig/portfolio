...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[50vh] pt-56 flex-col items-center justify-center bg-black-100 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-150 items-center justify-center isolate z-0 ">
        <motion.div
          ...
          className="absolute inset-auto right-1/2 overflow-visible w-[30rem] bg-gradient-conic from-purple via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 w-[30rem] bg-gradient-conic from-transparent via-transparent to-purple text-white [--conic-position:from_290deg_at_center_top]"
        >
